...
Una expresión regular, o _regex_ es una secuencia de caracteres utilizada como patrón para encontrar coincidencias. +
...
=== Coincidencia de categorías de caracteres
