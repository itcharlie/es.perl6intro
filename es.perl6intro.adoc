...
=== Sintaxis general
Perl 6 tiene *forma libre*: Eres libre (casi siempre) de utilizar cualquier cantidad de espacios en blanco.

*Sentencias* normalmente es una línea lógica de código y necesita finalizar con punto y coma:
`say "Hola" if True;`

*Expresiones* son sentencias especiales que devuelven un valor:
`1+2` devuelve `3`
...
*Operadores* se clasifican en tipos:

|===

| *Tipo* | *Significado* | *Ejemplo*

| Prefix | Antes del término | `++1`

| Infix | Entre términos | `1+2`

| Postfix | Después del término | `1++`

| Circumfix | Al principio y al final del término | `(1)`

| Postcircumfix | Después del término, al principio y al final de otro | `Array[1]`
